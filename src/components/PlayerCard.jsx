...
export default function PlayerCard({ player, team, stats }) {
  ...
  return (
    ...
    <Link
      ...
      className="block bg-gray-800 hover:bg-gray-700 transition rounded-lg shadow-md overflow-hidden"
    >
      <div className="flex justify-between items-center p-4">
        ...
        <div className="flex items-center">
          <img
            src={teamImage}
            alt={team?.name || 'Team'}
            className="w-16 h-16 rounded-full object-cover mr-4 border-2 border-blue-400 bg-gray-700"
          />
          <div>
        ...
        {stats?.goals && (
          <div className="text-right">
            <p className="text-3xl font-bold text-blue-300">{stats.goals}</p>
